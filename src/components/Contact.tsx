        ...
        <div>
          <Reveal>
            <p className="max-w-xl text-lg leading-relaxed">
              Want to talk about an internship, a project, or just swap notes
              on AI tooling? My inbox is open — I’ll get back to you as soon
              as I’m out of the lab.
            </p>
          </Reveal>
        ...
        <Reveal index={2} rotate={1.8}>
          ...
          >
            ...
            <p className="text-2xl font-bold italic leading-snug text-ink">
              “Talks to computers in {`{TypeScript}`}, humans in English &
              中文.”
            </p>
